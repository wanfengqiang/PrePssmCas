...
!mkdir ../data/feature/pretrain/protT5
!mkdir ../data/feature/pretrain/protT5/protT5_checkpoint
!mkdir ../data/feature/pretrain/protT5/sec_struct_checkpoint 
!mkdir ../data/feature/pretrain/protT5/output 
...
seq_path = "../data/train/Cas300.fasta"


per_residue = False
per_residue_path = "../data/feature/pretrain/protT5/output/per_residue_embeddings.h5" 

per_protein = True
per_protein_path = "../data/feature/pretrain/protT5/output/per_protein_embeddings_tumor.h5" 

sec_struct = False
sec_struct_path = "../data/feature/pretrain/protT5/output/ss3_preds.fasta" # file for storing predictions
